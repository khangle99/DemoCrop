...
internal struct Assets {
    ...
    static let green: UIColor = {
        if #available(iOS 12, *) {
            return color(userInterfaceStyles: [
                .light: UIColor(red: 15 / 255, green: 189 / 255, blue: 59 / 255, alpha: 1),
                // swiftlint:disable:next colon
                .dark:  UIColor(red: 41 / 255, green: 179 / 255, blue: 76 / 255, alpha: 1)
            ])
        } else {
            return UIColor(red: 15 / 255, green: 189 / 255, blue: 59 / 255, alpha: 1)
        }
        
    }()

    static var checkerboardPatternColor: UIColor = {
        if #available(iOS 13, *) {
            return color(userInterfaceStyles: [
            ...
            return renderCheckerboardPattern(colors: (UIColor(white: 200 / 255, alpha: 1),
                                                      UIColor(white: 255 / 255, alpha: 1)))
        }
    }()
